...
export class CustomerComponent implements AfterViewInit, OnInit {
	...
	displayedColumns: string[] = ['customerName', 'customerCode', 'customerAddress', 'phoneNumber', 'email', 'update', 'delete'];
	...
	addCustomer() {
		this.customer.createdUserId = this.authService.getUserId();
		this.customer.lastUpdatedUserId = this.authService.getUserId();
